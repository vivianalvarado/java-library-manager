# ☕ Console Library Manager (Java SE)

### 1. Datos Generales
* **Desarrolladora:** Vivian Jarumy Fernandez Alvarado
* **Curso Validado:** Java Fundamentals (Oracle Academy)
* **Nota Obtenida:** 17.4 / 20.0
* **Tecnología:** Java Standard Edition (JDK 17+)

### 2. Descripción del Proyecto
Sistema de gestión de inventario para bibliotecas desarrollado en Java. El proyecto se centra en la aplicación de los pilares de la **Programación Orientada a Objetos (POO)** y el manejo eficiente de estructuras de datos en memoria, prescindiendo de bases de datos externas para validar la lógica pura del lenguaje.
